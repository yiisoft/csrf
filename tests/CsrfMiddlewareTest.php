...
final class CsrfMiddlewareTest extends TestCase
{
    ...
    private function createCsrfMiddleware(bool $autoGenerateToken): CsrfMiddleware
    {
        return new CsrfMiddleware(
            new Psr17Factory(),
            new StatefulCsrfToken(new RandomCsrfTokenGenerator(), new MockCsrfTokenStorage())
        );
    }
    ...
    private function createCsrfMiddlewareWithToken(string $token): CsrfMiddleware
    {
        $middleware = new CsrfMiddleware(
            new Psr17Factory(),
            new StatefulCsrfToken(new RandomCsrfTokenGenerator(), $this->createStorageMock($token))
        );
